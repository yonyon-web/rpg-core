...
> **📖 ドキュメントの役割分担**
> - **このドキュメント**: Service層の詳細な実装仕様（インターフェース、実装例、Core Engine委譲）
> - **[実装要素.md](./実装要素.md)**: ライブラリ全体の概要と目指すもの
> - **[コアエンジン.md](./コアエンジン.md)**: Core Engineの完全ガイド
> - **[features/](./features/)**: 各機能の個別ドキュメント
