...
### 🎮 戦闘・操作に関する Service
1. [戦闘全体の進行を管理する Service](#戦闘全体の進行を管理する-service)
2. [戦闘中のコマンド選択を扱う Service](#戦闘中のコマンド選択を扱う-service)
3. [アイテム使用の流れを扱う Service](#アイテム使用の流れを扱う-service)

### 🧠 敵に関する Service
4. [敵の行動を自動決定する Service](#敵の行動を自動決定する-service)
5. [複数の敵をひとまとまりとして扱う Service](#複数の敵をひとまとまりとして扱う-service)

### 📈 成長・キャラクターに関する Service
6. [スキル習得の流れを管理する Service](#スキル習得の流れを管理する-service)
7. [職業・クラス変更の流れを管理する Service](#職業・クラス変更の流れを管理する-service)
8. [戦闘やイベントの報酬を処理する Service](#戦闘やイベントの報酬を処理する-service)

### 🎒 管理・編成に関する Service
9. [装備の変更を管理する Service](#装備の変更を管理する-service)
10. [パーティ編成を管理する Service](#パーティ編成を管理する-service)
11. [状態異常やバフ・デバフを管理する Service](#状態異常やバフ・デバフを管理する-service)

### 🛠 クラフト・育成に関する Service
12. [アイテム合成の流れを管理する Service](#アイテム合成の流れを管理する-service)
13. [装備やキャラクターの強化を管理する Service](#装備やキャラクターの強化を管理する-service)

### 💾 システム・支援に関する Service
14. [セーブとロードの流れを管理する Service](#セーブとロードの流れを管理する-service)
15. [戦闘や成長のシミュレーションを行う Service](#戦闘や成長のシミュレーションを行う-service)
